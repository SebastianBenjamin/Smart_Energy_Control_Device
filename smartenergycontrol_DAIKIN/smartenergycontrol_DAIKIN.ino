...
#define LED_PIN 12  // Define Buzzer Pin
...
IRDaikinESP ac(kIrLed);  // Use Daikin AC control
  ...
  double temp1 = dht1.readTemperature();
    ...
    if (currentCount != lastCount) {
      ...
      double humidity2 = dht2.readHumidity();
        ...
        int acTemp = calculateAcTemp(indoorTemp, outdoorTemp, maxCapacity, currentCount, minTemp, maxTemp);
       if(updatedToOne){
...
//         lcd.setCursor(0, 1);
//         lcd.print("System Inactive");
//         Firebase.RTDB.setString(&fbdo, "/Data/SystemSTS", "Inactive");
//     }
// }
